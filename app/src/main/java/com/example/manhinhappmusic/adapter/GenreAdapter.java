...
public class GenreAdapter extends RecyclerView.Adapter<GenreAdapter.ViewHolder> {
    ...
    public interface OnItemClickListener{
        void onItemClick(int position, Genre item);
    }
    ...
    public GenreAdapter(List<Genre> genreList, OnItemClickListener onItemClickListener){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(holder.itemView.getContext())
                .load(ApiService.BASE_URL + genre.getThumbnailUrl())
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onItemClickListener.onItemClick(holder.getAdapterPosition(), genre);
            }
        });
