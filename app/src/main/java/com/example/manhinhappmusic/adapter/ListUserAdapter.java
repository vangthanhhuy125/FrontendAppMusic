...
public class ListUserAdapter extends RecyclerView.Adapter<ListUserAdapter.UserViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, int position) {
        ...
        if ("ROLE_ARTIST".equalsIgnoreCase(user.getRole())) {
        ...
        if (user.getAvatarUrl() != null) {
            ...
            holder.imageUser.setImageResource(user.getAvatarUrl() != null ?
                    Integer.parseInt(user.getAvatarUrl()) : R.drawable.exampleavatar);
        }
