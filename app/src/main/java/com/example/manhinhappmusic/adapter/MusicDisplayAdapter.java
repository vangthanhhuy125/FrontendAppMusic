...
public class MusicDisplayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MusicDisplayAdapter(List<ListItem> listItemList, OnItemClickListener onItemClickListener, MusicDisplayFragment.HomeDisplayType homeDisplayType)
    {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder instanceof HomeMixPlaylistHolder)
        {
            ...
            homeMixPlaylistHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onItemClickListener.onItemClick(homeMixPlaylistHolder.getAdapterPosition());
                }
            });
        }
        else if(holder instanceof HomeSongViewHolder)
        {
            ...
            homeSongViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onItemClickListener.onItemClick(homeSongViewHolder.getAdapterPosition());
                }
            });
        }
            ...
            homeReleasePlaylistViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onItemClickListener.onItemClick(homeReleasePlaylistViewHolder.getAdapterPosition());
                }
            });
        }
        else
        {
            ...
            homeArtistHolder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onItemClickListener.onItemClick(homeArtistHolder.getAdapterPosition());
                }
            });
        }
    }
