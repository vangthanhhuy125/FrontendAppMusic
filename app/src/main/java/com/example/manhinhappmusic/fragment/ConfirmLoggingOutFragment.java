 ...
 * Use the {@link ConfirmLoggingOutFragment#newInstance} factory method to
...
public class ConfirmLoggingOutFragment extends DialogFragment {
     ...
     * @return A new instance of fragment ConfirmLoggingOutFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ConfirmLoggingOutFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        logOutButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getParentFragmentManager().setFragmentResult("request_log_out", null);
                dismiss();
            }
        });
    }
