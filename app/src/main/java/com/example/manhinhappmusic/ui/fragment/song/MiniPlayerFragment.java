...
public class MiniPlayerFragment extends BaseFragment {
    ...
    {
        songsCoverImage.setImageURI(Uri.parse(mediaPlayerManager.getCurrentSong().getCoverImageUrl()));
        ...
        Palette.from(BitmapFactory.decodeStream(this.getContext().getResources().openRawResource(Integer.parseInt(mediaPlayerManager.getCurrentSong().getCoverImageUrl())))).generate(palette -> {
